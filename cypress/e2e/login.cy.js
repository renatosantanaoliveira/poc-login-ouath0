describe("Login Auth0", () => {
  ...
  it("deve realizar login com sucesso", () => {
    ...
    cy.url({ timeout: 30000 }).should(
      "eq",
      `${Cypress.config("baseUrl")}${dashboardPath}`,
    );
  });
});
